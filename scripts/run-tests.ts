...
const tests: TestDef[] = [
  ...
  { name: "vnextBuildRetrievalOutputs", command: [...nodeWithTsx, "src/lib/runtime/vnext/__tests__/buildRetrievalOutputs.test.ts"] },
  { name: "vnextBuildTurnEvent", command: [...nodeWithTsx, "src/lib/runtime/vnext/__tests__/buildTurnEvent.test.ts"] },
  { name: "vnextComposeTurnPacket", command: [...nodeWithTsx, "src/lib/runtime/vnext/__tests__/composeTurnPacket.test.ts"] },
  { name: "vnextDecideTurn", command: [...nodeWithTsx, "src/lib/runtime/vnext/__tests__/decideTurn.test.ts"] },
  { name: "vnextExecuteTurn", command: [...nodeWithTsx, "src/lib/runtime/vnext/__tests__/executeTurn.test.ts"] },
  { name: "vnextHandleUserTurn", command: [...nodeWithTsx, "src/lib/runtime/vnext/__tests__/handleUserTurn.test.ts"] },
  { name: "vnextLegacyDecisionBridge", command: [...nodeWithTsx, "src/lib/runtime/vnext/__tests__/mapLegacyDecisionSignalsFromChatRoute.test.ts"] },
  { name: "vnextPostProcessTurn", command: [...nodeWithTsx, "src/lib/runtime/vnext/__tests__/postProcessTurn.test.ts"] },
  { name: "vnextRecentTurnsParity", command: [...nodeWithTsx, "src/lib/runtime/vnext/__tests__/recentTurnsParity.test.ts"] },
  { name: "vnextRenderPromptPreview", command: [...nodeWithTsx, "src/lib/runtime/vnext/__tests__/renderPromptPreview.test.ts"] },
  { name: "vnextRetrievalPlan", command: [...nodeWithTsx, "src/lib/runtime/vnext/__tests__/runRetrievalPlan.test.ts"] },
  { name: "vnextSessionMapping", command: [...nodeWithTsx, "src/lib/runtime/vnext/__tests__/sessionMapping.test.ts"] },
  { name: "vnextWritebackAndQueue", command: [...nodeWithTsx, "src/lib/runtime/vnext/__tests__/writebackAndQueue.test.ts"] },
